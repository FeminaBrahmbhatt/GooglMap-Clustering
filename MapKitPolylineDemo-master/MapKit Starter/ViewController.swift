...
class ViewController: UIViewController {
    ...
    var places = Place.sharedinstance.getPlaces
    
    override func viewDidLoad() {
        Place.sharedinstance.insertplace(title: "jammu&kashmir", subtitle:"welcome to j&k" , coordinate: CLLocationCoordinate2D(latitude: 33.7782,longitude: 76.5762))
        
        places = Place.sharedinstance.getPlaces
